...
//    public static final String CHARACTOR_FONT_CH_FILE = "F:/simhei.ttf";  //黑体常规
    ...
    public static Font createCHineseFont(float size, int style, BaseColor color) {
        ...
        try {
            URL resource = PDFUtil2.class.getClassLoader().getResource("simfang.ttf");
    ...
    public static void main(String[] args) {
        System.out.println("地板：\t"+38*38);
        System.out.println("墙：\t"+(2*38)*(38+1));
//        String fileName = "F:/test11.pdf";  //这里先手动把绝对路径的文件夹给补上。
//        PDFUtil2 PDFUtil2 = new PDFUtil2();
//
//        Font chapterFont = PDFUtil2.createCHineseFont(20, Font.BOLD, new BaseColor(0, 0, 255));//文章标题字体
//        Font sectionFont = PDFUtil2.createCHineseFont(16, Font.BOLD, new BaseColor(0, 0, 255));//文章小节字体
//        Font textFont = PDFUtil2.createCHineseFont(10, Font.NORMAL, new BaseColor(0, 0, 0));//小节内容字体
//
//        PDFUtil2.createDocument(fileName);
//        Chapter chapter = PDFUtil2.createChapter("糖尿病病例1", 1, 1, 0, chapterFont);
//        Section section1 = PDFUtil2.createSection(chapter, "病例联系人信息", sectionFont, 0);
//        Phrase text1 = PDFUtil2.createPhrase("如您手中有同类现成病例，在填写完以上基础信息后，传病例附件", textFont);
//        section1.add(text1);
//
//        Section section2 = PDFUtil2.createSection(chapter, "病例个人体会", sectionFont, 0);
//        Phrase text2 = PDFUtil2.createPhrase("1.下载病例生成PDF文档", textFont);
////      text2.setFirstLineIndent(20);  //第一行空格距离
//        section2.add(text1);
//        section2.add(text2);
//
//        List list = PDFUtil2.createList(true, false, 20);
//        String tmp = "还有什么能够文档。文档是 PDF 文档的所有元素的容器。 ";
//        ListItem listItem1 = PDFUtil2.createListItem(tmp, textFont);
//        ListItem listItem2 = PDFUtil2.createListItem("列表2", textFont);
//        list.add(listItem1);
//        list.add(listItem2);
//        section2.add(list);
//
//        PDFUtil2.writeChapterToDoc(chapter);
//        PDFUtil2.closeDocument();

//        readPDF("C:\\zc\\第06单元16-18讲义.pdf");
